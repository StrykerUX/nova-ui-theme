<?php
/**
 * Template Name: Dashboard Neo
 * 
 * Template para crear páginas de dashboard con estilo neo-brutalista.
 *
 * @package NovaUI
 */
    ...
    <aside class="dashboard-sidebar">
        ...
        <nav class="dashboard-navigation">
            <ul class="dashboard-menu">
                ...
                <li class="dashboard-menu-item">
                    <a href="<?php echo esc_url(home_url('/dashboard/analytics')); ?>">
                        <span class="dashboard-menu-icon">
                ...
                <li class="dashboard-menu-item">
                    <a href="<?php echo esc_url(home_url('/dashboard/chat-ai')); ?>">
                        <span class="dashboard-menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                        </span>
                        <span class="dashboard-menu-text">Chat AI</span>
                    </a>
                </li>
                <li class="dashboard-menu-item">
                    <a href="<?php echo esc_url(home_url('/dashboard/quick-links')); ?>">
                        <span class="dashboard-menu-icon">
                ...
                <li class="dashboard-menu-item">
                    <a href="<?php echo esc_url(home_url('/dashboard/documents')); ?>">
                        <span class="dashboard-menu-icon">
                ...
                <li class="dashboard-menu-item">
                    <a href="<?php echo esc_url(home_url('/dashboard/calendar')); ?>">
                        <span class="dashboard-menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                        </span>
                        <span class="dashboard-menu-text">Calendar</span>
                    </a>
                </li>
                <li class="dashboard-menu-item">
                    <a href="<?php echo esc_url(home_url('/dashboard/projects')); ?>">
                        <span class="dashboard-menu-icon">
                        ...
                        <span class="dashboard-menu-text">Projects</span>
                    </a>
                </li>
                <li class="dashboard-menu-item">
        ...
        <div class="dashboard-help">
            ...
            <div class="help-text">
                ...
                <p class="help-subtitle">Check out the docs</p>
            </div>
        </div>
    </aside>
    ...
    <main class="dashboard-main">
        <header class="dashboard-header">
            <div class="dashboard-header-start">
                <button class="dashboard-mobile-menu-toggle" aria-label="Toggle mobile menu">
            ...
            <div class="dashboard-header-end">
                <button id="notification-toggle" class="dark-mode-toggle" aria-label="Notifications">
                ...
                <div class="dashboard-user-menu">
                    <button class="dashboard-user-toggle" aria-expanded="false" aria-controls="user-dropdown">
                    ...
                    <div id="user-dropdown" class="dashboard-user-dropdown">
                        <ul class="dashboard-user-menu-list">
                            ...
                            <li>
                                <a href="<?php echo esc_url(home_url('/dashboard/subscription')); ?>">
        ...
        <div class="dashboard-content">
            <div class="dashboard-content-inner">
                <?php if (is_page_template('templates/template-dashboard-example.php')): ?>
                    <?php include(get_template_directory() . '/templates/partials/dashboard-example.php'); ?>
                <?php else: ?>
                    <?php
                    while (have_posts()) :
                        the_post();
...
<?php
// No incluir el footer normal, ya que tenemos nuestro propio layout
wp_footer();
?>
</body>
</html>
