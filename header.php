    ...
    <header id="masthead" class="site-header">
        <div class="site-branding">
            ...
            if ( $nova_ui_description || is_customize_preview() ) :
                ?>
                <p class="site-description"><?php echo $nova_ui_description; ?></p>
            <?php endif; ?>
        </div><!-- .site-branding -->

        <nav id="site-navigation" class="main-navigation">
            <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'nova-ui' ); ?></button>
            <?php
            wp_nav_menu(
                array(
