 ...
 *
 * Plantilla para mostrar un dashboard moderno con tarjetas de estadísticas y widgets.
 *
 * @package Nova_UI
 */
        ...
        <div class="card recent-activities-card">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h2><?php esc_html_e('Recent Activities', 'nova-ui'); ?></h2>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="activity-timeline">
                    <div class="activity-item">
                        <div class="activity-icon" style="background-color: #4ECDC4;">
                            <i class="ti ti-file-plus"></i>
                        </div>
                        <div class="activity-content">
                            <div class="activity-title"><?php esc_html_e('New report created', 'nova-ui'); ?></div>
                            <div class="activity-time">2 <?php esc_html_e('hours ago', 'nova-ui'); ?></div>
                            <div class="activity-description"><?php esc_html_e('Sarah created a new Q1 Financial Report', 'nova-ui'); ?></div>
                        </div>
                    </div>
                    
                    <div class="activity-item">
                        <div class="activity-icon" style="background-color: #FF6B6B;">
                            <i class="ti ti-user-plus"></i>
                        </div>
                        <div class="activity-content">
                            <div class="activity-title"><?php esc_html_e('New team member', 'nova-ui'); ?></div>
                            <div class="activity-time"><?php esc_html_e('Yesterday', 'nova-ui'); ?></div>
                            <div class="activity-description"><?php esc_html_e('Michael Johnson joined the Design Team', 'nova-ui'); ?></div>
                        </div>
                    </div>
                    
                    <div class="activity-item">
                        <div class="activity-icon" style="background-color: #F9DC5C;">
                            <i class="ti ti-message-dots"></i>
                        </div>
                        <div class="activity-content">
                            <div class="activity-title"><?php esc_html_e('New comment', 'nova-ui'); ?></div>
                            <div class="activity-time">3 <?php esc_html_e('days ago', 'nova-ui'); ?></div>
                            <div class="activity-description"><?php esc_html_e('Alex commented on Product Roadmap', 'nova-ui'); ?></div>
                        </div>
                    </div>
                </div>
                
                <div class="view-all-container">
                    <a href="#" class="view-all-link"><?php esc_html_e('View All Activities', 'nova-ui'); ?></a>
                </div>
            </div>
        </div>
